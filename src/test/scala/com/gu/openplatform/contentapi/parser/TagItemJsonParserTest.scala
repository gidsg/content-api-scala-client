...
class TagItemJsonParserTest extends FlatSpec with ShouldMatchers {
  ...
  lazy val tagItemResponse = JsonParser.parseItem(loadFile("item-tag.json")).get

  // generated by:
  // http://content.guardianapis.com/travel.json
  lazy val sectionItemResponse = JsonParser.parseItem(loadFile("item-section.json")).get


  // generated by:
  // http://content.guardianapis.com/travel/2010/aug/27/britains-best-budget-eats-oxford.json
  //   ?show-related=true
  lazy val contentItemResponse = JsonParser.parseItem(loadFile("item-content.json")).get
